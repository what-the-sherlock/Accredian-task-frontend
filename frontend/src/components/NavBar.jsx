        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link href="#steps" className={activeLink === 'steps' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('steps')}>Resources</Nav.Link>
            ...
            <span className="navbar-text">
              ...
              <HashLink to='#connect'>
                ...
                <button className="vvd"><span>Refer Now</span></button>
              </HashLink>
            </span>
          </Navbar.Collapse>
        </Container>
